...
A macOS menu bar app that displays your [OpenCode GO](https://opencode.ai) subscription usage in real time — rolling, weekly, and monthly limits with progress bars, all from your menu bar.
